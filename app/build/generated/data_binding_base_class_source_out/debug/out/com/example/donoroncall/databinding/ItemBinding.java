...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView lineshape,
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((LinearLayout) rootView, lineshape, textView, textView2, textView3);
    }
