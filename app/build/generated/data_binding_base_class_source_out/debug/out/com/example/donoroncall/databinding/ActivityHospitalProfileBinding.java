...
public final class ActivityHospitalProfileBinding implements ViewBinding {
  ...
  private ActivityHospitalProfileBinding(@NonNull RelativeLayout rootView, @NonNull TextView Email,
      @NonNull EditText Name, @NonNull EditText Phone, @NonNull Button back,
      @NonNull BottomNavigationView bottomNavigation, @NonNull Button btnsave,
      @NonNull Spinner city, @NonNull EditText cityedit, @NonNull TextView cityview,
      @NonNull TextView emailview, @NonNull ImageView imageView2, @NonNull TextView nameview,
      @NonNull Button password, @NonNull TextView phoneview, @NonNull TextView textView) {
  ...
  public static ActivityHospitalProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHospitalProfileBinding((RelativeLayout) rootView, Email, Name, Phone, back,
          bottomNavigation, btnsave, city, cityedit, cityview, emailview, imageView2, nameview,
          password, phoneview, textView);
    }
