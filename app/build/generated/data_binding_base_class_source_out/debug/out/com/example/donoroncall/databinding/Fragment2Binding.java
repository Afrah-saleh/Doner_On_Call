...
public final class Fragment2Binding implements ViewBinding {
  ...
  private Fragment2Binding(@NonNull RelativeLayout rootView, @NonNull Button butAdd,
  ...
  public static Fragment2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment2Binding((RelativeLayout) rootView, butAdd, simpleListView);
    }
