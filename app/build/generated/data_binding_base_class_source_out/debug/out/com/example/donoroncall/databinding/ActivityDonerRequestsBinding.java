...
public final class ActivityDonerRequestsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDonerRequestsBinding(@NonNull RelativeLayout rootView, @NonNull Button back,
  ...
  @NonNull
  public static ActivityDonerRequestsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDonerRequestsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doner_requests, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDonerRequestsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDonerRequestsBinding((RelativeLayout) rootView, back, bottomNavigation,
